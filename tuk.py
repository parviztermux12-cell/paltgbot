...
DECK_EFFECTS = {
    ...
    1:  (1.15, 0.20, 1.8),   # Ход 1 - красный стал опаснее
    2:  (1.2,  0.22, 2.0),   # Ход 2
    3:  (1.25, 0.25, 2.3),   # Ход 3 - красный теперь 25% потерь
    4:  (1.3,  0.28, 2.6),   # Ход 4
    5:  (1.35, 0.30, 3.0),   # Ход 5
    6:  (1.4,  0.32, 3.4),   # Ход 6
    7:  (1.45, 0.35, 3.8),   # Ход 7
    8:  (1.5,  0.38, 4.2),   # Ход 8
    9:  (1.55, 0.40, 4.7),   # Ход 9
    10: (1.6,  0.42, 5.2),   # Ход 10
    11: (1.7,  0.45, 5.8),   # Ход 11
    12: (2.0,  0.50, 7.0),   # Ход 12 - 50% потерь на красном
}
