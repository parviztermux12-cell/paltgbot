...
def mines_keyboard(user_id, reveal_all=False, no_actions=False):
    u = get_user_data(user_id)
    kb = InlineKeyboardMarkup()
...
def mines_handler(call):
    ...
    if action == "cash" and u["mines_started"]:
        ...
        bot.edit_message_text(
            ...
            call.message.message_id,
            parse_mode="HTML",
            reply_markup=mines_keyboard(user_id, reveal_all=True, no_actions=True)
        )
        return
